...
function exibirUsuario(req, res) {
    ...
    if (idUsuario == undefined) {
        ...
        usuarioModel.exibirUsuario(idUsuario)
            .then(
                function (resultado) {
                    console.log(`\nResultados encontrados: ${resultado.length}`);
                    console.log(`Resultados: ${JSON.stringify(resultado)}`); // transforma JSON em String
...
function cadastrar(req, res) {
    ...
    if (nome == undefined) {
        ...
        usuarioModel.cadastrar(nome, email, senha, confirmacaoSenha)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
...
function cadastrarPontos(req, res) {
    ...
    var fkUsuario = req.body.fkUsuarioSever;
    ...
    if (total == undefined) {
        ...
        // Passe os valores como parâmetro e vá para o arquivo usuarioModel.js
        usuarioModel.cadastrarPontos(total, fkUsuario)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
